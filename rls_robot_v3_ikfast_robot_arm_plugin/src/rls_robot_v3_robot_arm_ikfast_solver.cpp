...
///
/// ikfast version 0x10000049 generated on 2020-08-13 13:34:29.663083
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
x18=(x1*x2);
IkReal x19=(x1*x8);
eetrans[0]=(((x7*(((((-1.0)*x18*x9))+((x12*x16))))))+((x0*x19))+(((0.022)*x16))+(((-0.025)*x1))+x19+((x11*x16))+((x5*((((x16*x9))+((x12*x18)))))));
IkReal x20=((1.0)*x12);
IkReal x21=((1.0)*x15);
IkReal x22=((1.0)*x6*x8);
eetrans[1]=(((x7*((((x17*x9))+(((-1.0)*x15*x20))))))+(((-1.0)*x22))+(((0.025)*x6))+(((-1.0)*x0*x22))+(((-0.022)*x15))+((x5*(((((-1.0)*x17*x20))+(((-1.0)*x21*x9))))))+(((-1.0)*x11*x21)));
IkReal x23=((1.0)*x9);
eetrans[2]=((0.205)+((x0*x14))+((x5*(((((-1.0)*x2*x23))+((x12*x3))))))+(((-1.0)*x4*x8))+(((-0.022)*x2))+x14+((x7*(((((-1.0)*x23*x3))+(((-1.0)*x12*x2)))))));
IkReal x24=((1.0)*x10);
if( ((((x7*(((((-1.0)*x24*x3))+(((-1.0)*x13*x2))))))+((x5*(((((-1.0)*x2*x24))+((x13*x3)))))))) < -1-IKFAST_SINCOS_THRESH || ((((x7*(((((-1.0)*x24*x3))+(((-1.0)*x13*x2))))))+((x5*(((((-1.0)*x2*x24))+((x13*x3)))))))) > 1+IKFAST_SINCOS_THRESH )
    continue;
eerot[0]=IKacos((((x7*(((((-1.0)*x24*x3))+(((-1.0)*x13*x2))))))+((x5*(((((-1.0)*x2*x24))+((x13*x3))))))));
return;
}
IKFAST_ASSERT(0);
}
...
IkReal x32=((1.0)*pz);
IkReal x33=((0.088)*pz);
IkReal x34=((0.2952)+(((-1.44)*pz)));
IkReal x35=((0.01804)+(((-1.0)*x33)));
IkReal x36=((0.82)+(((-4.0)*pz)));
IkReal x37=((0.41)+(((-2.0)*pz)));
IkReal x38=((0.05)*pz);
IkReal x39=((0.41)*pz);
IkReal x40=((0.27)+(((-1.0)*x32)));
IkReal x41=((0.14)+(((-1.0)*x32)));
IkReal x42=((-0.22)+(((-1.0)*x32)));
IkReal x43=((-0.09)+(((-1.0)*x32)));
IkReal x44=((-0.27)+pz);
IkReal x45=((-0.14)+pz);
IkReal x46=((1.0)*(IKcos(r00)));
IkReal x47=((-1.0)+(((-1.0)*x46)));
IkReal x48=((1.0)+(((-1.0)*x46)));
IkReal x49=((1.0)*(px*px));
IkReal x50=((1.0)*(py*py));
IkReal x51=(pz*x32);
IkReal x52=(px*x28);
IkReal x53=(py*x29);
IkReal x54=((0.006)*x53);
IkReal x55=((0.72)*x52);
IkReal x56=((0.72)*x53);
IkReal x57=((2.0)*x52);
IkReal x58=((2.0)*x53);
IkReal x59=((0.094)*x53);
IkReal x60=((0.094)*x52);
IkReal x61=(x54+x27);
IkReal x62=(x38+x59);
IkReal x63=((0.003)+x52+(((-1.0)*x53)));
IkReal x64=((-0.047)+x53+(((-1.0)*x52)));
IkReal x65=((0.00216)+x55+(((-1.0)*x56)));
IkReal x66=((0.006)+x57+(((-1.0)*x58)));
IkReal x67=((0.05)+x57+(((-1.0)*x58)));
IkReal x68=((-0.05)+x58+(((-1.0)*x57)));
IkReal x69=((-0.03384)+x56+(((-1.0)*x55)));
IkReal x70=((-0.094)+x58+(((-1.0)*x57)));
IkReal x71=(x49+x51+x50);
IkReal x72=((0.03604)+(((-1.0)*x33))+x55+(((-1.0)*x56)));
IkReal x73=((0.05404)+(((1.44)*x52))+(((-1.0)*x33))+(((-1.44)*x53)));
IkReal x74=((((0.006)*x52))+x71);
IkReal x75=(x71+x60);
IkReal x76=((-0.088209)+(((-1.0)*x74))+x61);
IkReal x77=((-0.135009)+(((-1.0)*x74))+x61);
IkReal x78=((-0.315009)+(((-1.0)*x74))+(((1.13)*pz))+x54);
IkReal x79=((-0.037809)+(((-1.0)*x74))+x39+x54);
IkReal x80=((0.057191)+(((-1.0)*x75))+x62);
IkReal x81=((0.010391)+(((-1.0)*x75))+x62);
IkReal x82=((-0.022009)+(((-0.31)*pz))+(((-1.0)*x75))+x59);
IkReal x83=((-0.040009)+(((-1.0)*x75))+x39+x59);
op[0]=x76;
op[1]=0;
op[2]=x77;
op[3]=x76;
...
IkReal x84=htj1*htj1;
CheckValue<IkReal> x85=IKPowWithIntegerCheck(((1.0)+x84),-1);
if(!x85.valid){
continue;
}
cj1array[numsolutions]=((x85.value)*(((1.0)+(((-1.0)*x84)))));
CheckValue<IkReal> x86=IKPowWithIntegerCheck(((1.0)+(htj1*htj1)),-1);
if(!x86.valid){
continue;
}
sj1array[numsolutions]=((2.0)*htj1*(x86.value));
}
if(isinf(htj2)){
...
IkReal x87=htj2*htj2;
CheckValue<IkReal> x88=IKPowWithIntegerCheck(((1.0)+x87),-1);
if(!x88.valid){
continue;
}
cj2array[numsolutions]=((x88.value)*(((1.0)+(((-1.0)*x87)))));
CheckValue<IkReal> x89=IKPowWithIntegerCheck(((1.0)+(htj2*htj2)),-1);
if(!x89.valid){
continue;
}
sj2array[numsolutions]=((2.0)*htj2*(x89.value));
}
if(isinf(htj3)){
...
IkReal x90=htj3*htj3;
CheckValue<IkReal> x91=IKPowWithIntegerCheck(((1.0)+x90),-1);
if(!x91.valid){
continue;
}
cj3array[numsolutions]=((x91.value)*(((1.0)+(((-1.0)*x90)))));
CheckValue<IkReal> x92=IKPowWithIntegerCheck(((1.0)+(htj3*htj3)),-1);
if(!x92.valid){
continue;
}
sj3array[numsolutions]=((2.0)*htj3*(x92.value));
}
...
IKFAST_API const char* GetKinematicsHash() { return "8d8c1bcdf40750932eeab5629de48dbc"; }
